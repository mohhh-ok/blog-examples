...
6. **OpenVoice v2** (06-19 結果を流用) — MIT、設定見直しは効果薄と判断

**実測結果は [`findings.md`](./findings.md) を参照**。v2 と v3 で得意領域が大きく違うこと、v3 の JA は単純な kanji 入力だと CER 0.25 で崩壊することなど、想定外のトレードオフが出ている。
